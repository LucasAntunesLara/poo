...
let item1 = new ItemPedido(1, 'Item 1', 10)
let item2 = new ItemPedido(2, 'Item 2', 20)
let item3 = new ItemPedido(3, 'Item 3', 30)

let cliente = new Cliente(1, 'Nome', '999.999.999-99', 'Email', 'Endereco')
